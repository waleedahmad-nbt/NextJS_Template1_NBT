  ...
  return (
    ...
    {/* Hero Section 1 */}
      ...
      <div className='mx-4 md:mx-16 flex flex-col md:flex-row gap-4 mt-6 md:mt-10'>
        ...
        <div className="relative col-span-1 flex rounded-lg h-[250px] w-full group overflow-hidden">
          <img
          ...
          <div className="absolute flex items-center justify-center">
            <div className="w-full flex flex-row">
              <div className="flex flex-col justify-between  ml-3 mt-5 px-5">
                ...
                <div className="text-md underline mt-10 ">
                  <Link href="/pages/Shop">
          ...
          <div className="absolute flex items-center justify-center">
            <div className="w-full flex flex-row">
              <div className="flex flex-col justify-between ml-4 mt-5 px-5">
                ...
                <div className="text-md underline text-white mt-10">
                  <Link href="/pages/Shop">
          ...
          <div className="absolute flex items-center justify-center">
            <div className="w-full flex flex-row">
              <div className="flex flex-col justify-between ml-4 mt-5 px-5">
                ...
                <div className="text-md text-white underline mt-10">
                  <Link href="/pages/Shop">
                    <span>Shop Now</span>
                  </Link>
                </div>
