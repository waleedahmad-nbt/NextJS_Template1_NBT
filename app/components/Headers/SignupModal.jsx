          ...
          <div className="bg-white p-6 mt-10 rounded-md ">
            ...
            <form className="space-y-6 mt-7" action="#">
              ...
              <div className="flex flex-row gap-2 mb-4 items-center text-center">
                <div>
                  <input
                    ...
                    name="Name"
                    id="firstname"
                    className="bg-transparent border p-2.5 w-[210px] py-3 border-gray-300 text-gray-900 sm:text-sm rounded-full  block"
              ...
              <input
                ...
                name="Username"
                id="Username"
                className="bg-transparent border border-gray-300 text-gray-900 sm:text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-[436px] h-[45px] p-2.5"
              ...
              <div>
                <input
                  ...
                  name="email"
                  id="email"
                  className="bg-transparent border border-gray-300 text-gray-900 sm:text-sm rounded-full block w-[436px] h-[45px] p-2.5 py-3"
                  placeholder=""
                  required=""
                />
              </div>
              ...
              <button
                onClick={onSignUp}
                type="submit"
                className="w-full text-white bg-black hover:scale-105 font-medium 
