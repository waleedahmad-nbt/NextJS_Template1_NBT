    ...
    return (
        <>
            <main id="content" role="main" className="fixed inset-0 z-50 flex items-center justify-center">
                <div className="mt-7 bg-white w-[500px] h-[363px] rounded-xl shadow-lg dark:bg-gray-800 dark:border-gray-700">
                    <div className="p-4 sm:p-7">
                        <div className="text-center">
                            <h1 className="text-4xl font-bold font-serif mb-4 mt-6 text-gray-900 dark:text-white">Lost your password?</h1>
                            <p className="mt-2 text-sm text-gray-800 dark:text-gray-400 leading-6">
                                ...
                                <div className="grid gap-y-4">
                                    <div>
                                        <div className="relative mt-3 mb-3">
                                            ...
                                            border-gray-300 text-gray-900 text-base rounded-full  block dark:bg-gray-700 dark:border-gray-600"
