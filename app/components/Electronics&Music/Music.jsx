        ...
        <>
            ...
            <div className='hidden lg:block'>
                <div className='flex flex-row mt-10 mx-10 cursor-pointer '>
                    ...
                    <div className='w-3/4'>
                        {/* Left Side */}
                        <div className="relative col-span-1 flex rounded-lg lg:h-[300px] group overflow-hidden">
                            <img
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="w-full flex flex-row">
                                    <div className="flex flex-col m-10">
                                        <h3 className="text-3xl font-bold text-black">Sony Headphone</h3>
                                        <span className="text-3xl font-bold text-black"> at Best Prices</span>
                            ...
                            <div className="absolute inset-0 flex">
                                <div className="flex flex-col justify-between">
                                    <div className="text-lg font-semibold m-3">
                                        <span className='text-black font-bold '>Fitness <br />Headphones</span>
                                    </div>
                        ...
                        <div className="relative flex rounded-lg h-full group overflow-hidden">
                            ...
                            <div className="absolute inset-0 flex">
                                <div className="w-full flex flex-row">
                                    <div className="flex flex-col justify-between">
                                        <div className="text-lg font-semibold m-3">
                                            <span className='text-black font-bold '>MP3 Players</span>
                                        </div>
                                ...
                                <div className="w-full flex flex-row">
                                    <div className="flex flex-col justify-between">
                                        <div className="font-semibold m-3 ">
                                            <span className='text-black text-lg font-bold '>Microphones</span>
                                        </div>
                        ...
                        <div className="relative flex rounded-lg h-full group overflow-hidden">
                            ...
                            <div className="absolute inset-0 flex">
                                <div className="w-full flex flex-row">
                                    <div className="flex flex-col justify-between">
                                        <div className="font-semibold m-3">
                                            <span className='text-black text-lg font-bold '>Bluetooth <br /> speakers</span>
                                        </div>
                                        <p className='font-semibold text-gray-500 m-3'>2 Items</p>
                                    </div>
                                </div>
                        ...
                        <div className="relative flex rounded-lg h-full group overflow-hidden">
                            ...
                            <div className="absolute inset-0 flex">
                                <div className="w-full flex flex-row">
                                    <div className="flex flex-col justify-between">
                                        <div className="font-semibold m-3">
                                            <span className='text-black text-lg font-bold '>on-ears & <br /> over-ears </span>
                                        </div>
                                        <p className='font-semibold text-gray-500 m-3'>2 Items</p>
                        ...
                        <div className="relative flex rounded-lg h-full group overflow-hidden">
                            ...
                            <div className="absolute inset-0 flex">
                                <div className="w-full flex flex-row">
                                    <div className="flex flex-col justify-between">
                                        <div className="font-semibold m-3">
                                            <span className='text-black text-lg font-bold '>Headphone <br /> Accessories</span>
                                        </div>
                                        <p className='font-semibold text-gray-500 m-3'>2 Items</p>
