        ...
        <div className="mt-20">
          ...
          {favQuantity === 0 ? (
            ...
            <div className="flex flex-col space-y-6 mt-9 mx-8 md:mx-20">
              {favourites.map((item) => {
                const { id, imageSrc, title, originalPrice, discountedPrice } =
                  item;
                return (
                  <>
                    <div key={id} className="flex flex-row  items-center">
                      ...
                      <div className="flex flex-col">
                        <p
                          ...
                          className="text-md cursor-pointer font-semibold hover:text-gray-400 duration-500 ease-in-out"
                        >
                          {title}
                        </p>
                        <span className="text-[#32BDE8] text-sm">
                          ${discountedPrice}
                        </span>
                        <p className="text-sm font-medium">December 18, 2023</p>
                      </div>
                      <button
                        onClick={() => handleProductClick(item)}
                        type="submit"
          ...
          <div
            className="flex flex-row mx-4 md:mx-20 mt-20 gap-5 items-center"
