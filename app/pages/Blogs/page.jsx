                ...
                <div className='flex flex-col lg:flex-row  gap-5 mt-24 pr-4'>
                    <div className='w-[100%] lg:w-[75%] h-full'>
                        <div className='flex flex-col text-center items-center gap-3'>
                            <p className='text-sm hover:bg-[#e02b2b] font-semibold hover:text-white text-black p-1 duration-300'>LIFE STYLE</p>
                            <p className='text-4xl font-semibold'>Hook up a receiver for your home theater</p>
                        ...
                        <div className='mt-10'>
                            <img src="https://minimog-4437.kxcdn.com/supergear/wp-content/uploads/sites/2/2022/02/blog_geart_02-870x563.jpg"
                                className=''
                                alt="" />
                        </div>
                        </div>
                        ...
                        <div className='mt-7'>
                            <p className=' font-semibold text-xl text-[#2b2b2b]'>Officially available for pre-order in the U.S. today on the Valentino Beauty site, the opulent multi-piece collection draws inspiration from Valentino's storied 61-year history, imbuing each luxe piece with the "uniqueness, extravaganza, and experimentation" that defines its haute couture collections. </p>
                        </div>

                        <div className='text-md mb-7  text-start text-[#666666] font-medium'>
                            <p className='my-6'>But don't let those couture connotations fool you. Rest assured, there's nothing stuffy, exclusive, or conventional about this cosmetic lineup.</p>
                            <p>
                                Designed under the discerning eye of Pierpaolo Piccioli, Maison Valentino's Creative Director,
                                and developed in partnership with L'Oreal Paris, each of the versatile, multi-finish products is designed
                                to "speak to the freedom of expression and individuality that lies at the core of the brand," states the
                                press release. As such, you can expect a wide array of products and shades that work across all genders,
                                ages, and cultures, each one intended to evoke freedom,
                                creativity, and the signature modern glamour that Valentino does oh so well.
                            </p>
                        </div>

                        <div className='mt-12 flex flex-col gap-8'>
                            <h2 className='text-2xl '>The Inspiration Behind Valentino Beauty</h2>
                            <p className='text-[#666666]'>To celebrate this expressive and inclusive initiative, Piccioli even ventured behind the camera, shooting 16 models from varied backgrounds, all united by the Rosso Valentino lipstick, forming what he describes as "a Valentino chorus."</p>
                            <img src="https://minimog-4437.kxcdn.com/supergear/wp-content/uploads/sites/2/2022/02/product_supergear_11_4-800x540.jpg"
                        ...
                        <p className='text-base text-[#666666]'>Excited? So are we. Ahead, check out the ten products our editors will most certainly be adding to cart today, along with some additional details about how to shop each one.The Valentino Beauty collection is now available for pre-order through the Valentino site, with delivery expected by early July.</p>
                    ...
                    <div className='w-[100%] lg:w-[25%] flex flex-col gap-6'>
                        ...
                        <div>
                            ...
                            <div className='flex flex-row flex-wrap gap-3'>
                                <p className='hover:underline hover:text-gray-500 text-gray-600 font-semibold'>audio</p>
                                <p className='hover:underline hover:text-gray-500 text-gray-600 font-semibold'>life style</p>
                                <p className='hover:underline hover:text-gray-500 text-gray-600 font-semibold'>smart watch</p>
                                <p className='hover:underline hover:text-gray-500 text-gray-600 font-semibold'>sport watch</p>
                                <p className='hover:underline hover:text-gray-500 text-gray-600 font-semibold'>supergear</p>
                                <p className='hover:underline hover:text-gray-500 text-gray-600 font-semibold'>technology</p>
                            </div>
                        </div>
