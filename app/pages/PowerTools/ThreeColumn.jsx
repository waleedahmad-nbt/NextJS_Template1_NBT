...
import { addToCart, addToFavorites, setPowerToolsDetails } from '@/app/lib/redux/slices/cartSlice';
import { PowerTools } from '@/app/PowerToolsData';
...
const ThreeColumn = () => {
    ...
    const handlePowerToolsClick = (product) => {
        dispatch(setPowerToolsDetails(product));
        router.push(`/pages/PowerToolsDetails?${product.title}`);
    }

    return (
        <>
            <div className={`grid grid-cols-2 lg:grid-cols-3`}>
                {PowerTools.map(product => (
                    <>
                        <div
                            key={product.id}
                            ...
                            onClick={()=>handlePowerToolsClick(product)}
                        >
