    ...
    return (
        <>
            <div className='flex flex-col md:flex-row mt-10'>
                ...
                {/* Main Image */}
                <div
                    className='relative items-center w-full md:w-2/6'
                ...
                >
                    <div className="relative">
                        {isHovered && (
                            <>
                                <button className="text-black transition-opacity duration-500
                                absolute p-2 flex text-center justify-center h-[45px] w-[45px] top-1/2 left-4 transform -translate-y-1/2 text-2xl hover:bg-black hover:text-white bg-[#F2F2F2] rounded-full" onClick={handlePrevClick}>
                                    <GrFormPreviousLink />
                                </button>
                                <button className=" transition-opacity duration-500
                                absolute p-2 flex text-center justify-center h-[45px] w-[45px]
                                 top-1/2 right-4 transform -translate-y-1/2 text-black text-2xl hover:bg-black hover:text-white bg-[#F2F2F2] rounded-full" onClick={handleNextClick}>
                                    <GrFormNextLink />
                                </button>
                            </>
                        )}
                ...
                {/* Content */}
                < div className='flex flex-col gap-3 mt-2 justify-center ml-0 md:ml-16 w-full md:w-2/5' >
                    ...
                    <div className='flex flex-row my-2 justify-between mt-6 font-thin'>
                        <div>
                    ...
                    <button className='w-full text-lg text-white font-semibold h-12 mt-1 bg-black rounded-full
                    ...
                    <div className='w-full pt-4 h-[80px] bg-[#F1F1F1] gap-2 mt-3 flex flex-col items-center'>
