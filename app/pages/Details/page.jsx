...
const Details = () => {
    ...
    const counter = useSelector((state) => state.cart.items.find(item => item.id === selectedProduct.id)?.quantity || 0);
                        ...
                        <>
                            ...
                            >
                                <div className="relative">
                                    <div className="relative group" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                                        ...
                                        <img src={selectedProduct.imageSrc} alt="Main Image" className='w-[450px] h-[470px] object-cover' />
                                    </div>
                                </div>
                            </div>
                            ...
                            < div className='flex flex-col mt-6 md:w-1/3 lg:w-1/2 mx-auto md:mx-0' >
                                <div className='flex flex-row '>
                                    ...
                                    {/* <WishlistModal /> */}
                                    <div onClick={() => handleAddToFavorites(selectedProduct)} className=' px-3 text-xl mt-24 bg-white border-2 w-12 h-12 flex items-center rounded-full text-black hover:text-white hover:bg-black duration-700 transform-gpu'>
                                        <FaRegStar />
                                    </div>
                                </div>
                                ...
                                <div className='flex flex-row my-2 px-3 justify-between mt-6 font-thin'>
                                    <div>
                                        <p className='text-[#32BDE8] text-2xl font-semibold'>${selectedProduct.originalPrice}</p>
                                    </div>
                                ...
                                <div className='flex flex-row gap-3 md:gap-8 items-center'>
                                    ...
                                    <button onClick={() => handleAddToCart(selectedProduct)} className='w-full text-md text-black font-semibold h-12 mt-3 bg-[#F1F1F1] rounded-full hover:bg-black
