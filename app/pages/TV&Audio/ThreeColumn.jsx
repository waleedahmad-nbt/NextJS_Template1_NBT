...
import { addToCart, addToFavorites,setComputersTabletsDetails, setTvAudioDetails } from '@/app/lib/redux/slices/cartSlice';
...
const ThreeColumn = () => {
    ...
    const handleAudioClick = (product) => {
        dispatch(setTvAudioDetails(product));
        router.push(`/pages/TV&AudioDetails?${product.title}`);
    }

    return (
        <>
            <div className={`grid grid-cols-2 lg:grid-cols-3`}>
                {TvandAudio.map(product => (
                    <>
                        <div
                            key={product.id}
                            ...
                            onClick={()=>handleAudioClick(product)}
                        >
