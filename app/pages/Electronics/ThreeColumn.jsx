...
import { addToCart, addToFavorites,setComputersTabletsDetails, setElectronicsDetails } from '@/app/lib/redux/slices/cartSlice';
...
const ThreeColumn = () => {
    ...
    const handleElectronicsClick = (product) => {
        dispatch(setElectronicsDetails(product));
        router.push(`/pages/ElectronicsDetails?${product.title}`);
    }
                ...
                {Electronics.map(product => (
                    <>
                        <div
                            ...
                            onClick={()=>handleElectronicsClick(product)}
                        >
