        ...
        <>
            ...
            <div className='mt-20 mx-20'>
                <div className='flex justify-center'>
                    <h1 className='text-4xl leading-10 font-bold'>Search results for: "headphone"</h1>
                </div>
            </div>

            <div className='mt-8 mx-12'>
                <p className='text-xl font-medium'>We found some products for you.</p>
                <div className='flex flex-row flex-wrap'>
                    {products.map(product => (
                        <>
                            <div key={product.id} className='relative cursor-pointer h-[500px] w-[300px] mt-6 p-3 rounded-lg group gap5 overflow-hidden'>

                                {/* Image container */}

                                <div className='relative w-[270px] h-[270px] p-3 overflow-hidden transition-transform group-hover:transform duration-700 ease-in-out group-hover:scale-105'>
                                    <img
                                ...
                                < div className='flex flex-col gap-2 mt-2' >
                                    ...
                                    {/* Read more button */}
                                    <a
                                        className="bg-[#F1F1F1] mt-2 text-black px-5 mb-3 group-hover:bg-black group-hover:text-white 
                                        flex text-center justify-center font-semibold py-3 rounded-full  duration-300
                                         ease-in-out transform hover:scale-105 opacity-0 group-hover:opacity-100 transition-opacity"
                                    >
                                        Select Options
                                    </a>
                                </div>
