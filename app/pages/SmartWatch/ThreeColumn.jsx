...
import { addToCart, addToFavorites,setComputersTabletsDetails, setWatchDetails } from '@/app/lib/redux/slices/cartSlice';
...
const ThreeColumn = () => {
    ...
    const handleWatchClick = (product) => {
        dispatch(setWatchDetails(product));
        router.push(`/pages/SmartWatchDetails?${product.title}`);
    }
