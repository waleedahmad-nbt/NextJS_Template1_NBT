...
import { addToCart, addToFavorites, setHeadphonesDetails, setWatchDetails } from '@/app/lib/redux/slices/cartSlice';
import { Headphones } from '@/app/HeadphonesData';
...
const ThreeColumn = () => {
    ...
    const handleHeadphonesClick = (product) => {
        dispatch(setHeadphonesDetails(product));
        router.push(`/pages/HeadphonesDetails?${product.title}`);
    }
                ...
                {Headphones.map(product => (
                    <>
                        <div
                            ...
                            onClick={()=>handleHeadphonesClick(product)}
                        >
