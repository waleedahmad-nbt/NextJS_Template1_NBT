...
import { addToCart, addToFavorites,setCellPhoneDetails,setComputersTabletsDetails } from '@/app/lib/redux/slices/cartSlice';
import { CellPhone } from '@/app/CellphoneData';
...
const ThreeColumn = () => {
    ...
    const handleCellPhoneClick = (product) => {
        dispatch(setCellPhoneDetails(product));
        router.push(`/pages/CellphoneDetails?${product.title}`);
    }
                ...
                {CellPhone.map(product => (
                    <>
                        <div
                            ...
                            onClick={()=>handleCellPhoneClick(product)}
                        >
